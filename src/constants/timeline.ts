export const timeline = [
  ...
  {
    title: 'Docente particular / Programación',
    date: 'enero 2022 - octubre 2022',
    description: 'Clases de lógica, desarrollo y modelado de sistemas a distinta escala para alumnos de educación superior.'
  }
]
